...
[Obsolete(
    "Not used due to rewriting. However, it's still here since some other VRChat WebSocket data is sent can be used for this at which point I will remove the obsolete tag.")]
public class WebsocketContainer
{
    public class Content
    {
        ...
        [JsonProperty("type")] public string ContentType { get; set; }
